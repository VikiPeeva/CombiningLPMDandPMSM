...
from promosim.algo.measures.elementary import node_similarity
...
if __name__ == '__main__':
    ...
    for name1, net1 in nets.items():
        for name2, net2 in nets.items():
            df_res[name1][name2] = node_similarity(net1, net2)

    df_res = 1 - df_res
    df_res.to_csv(res_directory + "/model_node_distances.csv")
